...
export function HomePageClient() {
  ...
  const bottomCtaLabel = isAuthenticated ? "Ouvrir mon dashboard" : "Créer un compte gratuit"
            ...
            <div className="p-5 sm:p-6">
              ...
              <div className="rounded-2xl border border-border bg-background p-3.5">
                ...
                <p className="text-sm leading-6 text-muted-foreground">
                  &laquo; Explique-moi pourquoi BTC et ETH sont prioritaires ici. &raquo;
                </p>
      ...
      <footer className="border-t border-border bg-secondary px-5 py-10 pb-24 sm:px-6 md:pb-10">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-4 md:flex-row">
          ...
          <p className="text-center text-xs text-muted-foreground">
            &copy; 2026 Axiom. Les cryptomonnaies comportent des risques de perte en capital. Ce n&apos;est pas un conseil financier.
          </p>
