...
function PortfolioLineChart({
  ...
  const missingHistoryData = allocations.length > 0 && selectedChange === null
  ...
  const hasBtcData = mergedData.some((point) => point.btc !== null)
  const hasEthData = mergedData.some((point) => point.eth !== null)
